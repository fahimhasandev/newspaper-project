...
const NewsCard = (props = {}) => {
  ...
  return (
    <div className=" p-4 bg-white rounded-lg shadow-md">
      ...
      {/* Thumbnail Image */}
      <img src={news.image_url} alt="Thumbnail" className="w-full  object-cover rounded-lg mb-4" />
      ...
      <div className="flex items-center justify-between text-gray-600 text-sm">
        ...
        <div className="flex items-center">
          {[...Array(5)].map((_, i) => (
            <AiFillStar key={i} className={`text-yellow-500 ${i < Math.round(news.rating.number) ? "" : "opacity-50"}`} />
          ))}
